...
public class PhysicsManager : MonoBehaviour 
{
    ...
    private void stepExplicit(ISimulable o)
    {
        ...
        m_vxPre = o.getPositionVector();
        m_vvPre = o.getVelocityVector();

        o.setPositionVector(o.getPositionVector() + TimeStep * o.getVelocityVector());
        o.setVelocityVector(o.getVelocityVector() + TimeStep * (o.getForceVector() / o.getMassVector()));
    }
	...
	{
        // TO COMPLETE: Exercise 2
        VectorXD vel = o.getVelocityVector();
        VectorXD pos = o.getPositionVector();

        o.setVelocityVector(vel + (TimeStep/2) * (o.getForceVector()/o.getMassVector()));
        o.setPositionVector(pos + (TimeStep/2) * vel);

        o.updateForcesAndMatrices();

        VectorXD velact = o.getVelocityVector();
        VectorXD posact = o.getPositionVector();

        o.setVelocityVector(vel + TimeStep * (o.getForceVector() / o.getMassVector()));
        o.setPositionVector(pos + TimeStep * velact);
    }
	...
	{   
        ...
        VectorXD oldPos = m_vxPre;
        VectorXD oldVel = m_vvPre;
        VectorXD pos = o.getPositionVector();
        VectorXD vel = o.getVelocityVector();

        o.setPositionVector(2*o.getPositionVector() - oldPos + (o.getForceVector()/o.getMassVector())*TimeStep*TimeStep);
        o.setVelocityVector((o.getPositionVector() - oldPos) / (2*TimeStep));
    ...
    private void stepSemiImplicit(ISimulable o)
	{
        ...
        A = o.getMassMatrix() + TimeStep * o.getDampingMatrix() + TimeStep * TimeStep * o.getSpringsJacobian();
        B = (o.getMassMatrix() + TimeStep * o.getDampingMatrix()) * o.getVelocityVector() + TimeStep * o.getForceVector();

        VectorXD vel = A.Solve(B);

        o.setVelocityVector(vel);
        o.setPositionVector(o.getPositionVector() + TimeStep * o.getVelocityVector());
